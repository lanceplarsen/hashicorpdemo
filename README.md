...
We need to add a template for Nomad to swap the dummy api-key with a valid api-key at container runtime. You can see an example of my key here: https://storage.googleapis.com/llarsen-hashicorp-bucket/nomad/api_config.tpl , or in the project. Make this file public in your storage bucket.
